...
#mapfile = ['LANL_App1.dmp0.map', 'btio.16pe.simple.map', 'flash.64PE.hdf5_plt_crn_0000.map', 'app2_ind.map', 'app3.map', 'fstest.map', 'app2_iolib.map', 'app2_mpiio_col.map', 'flash.64PE.hdf5_plt_cnt_0000.map', 'flash64.map', 'flash.64PE.hdf5_chk_0000.map', 'chombo64.map']
